...
from ..models.request_to_pay_result_status import RequestToPayResultStatus
...
T = TypeVar("T", bound="RequestToPayResult")
...
class RequestToPayResult:
    ...
    Attributes:
        ...
        external_id (str | Unset): External id provided in the creation of the requestToPay transaction.
        ...
        status (RequestToPayResultStatus | Unset):
    ...
    status: RequestToPayResultStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_status, Unset):
            ...
            status = RequestToPayResultStatus(_status)
        ...
        request_to_pay_result.additional_properties = d
        return request_to_pay_result
