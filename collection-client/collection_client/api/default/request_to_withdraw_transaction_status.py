...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1_0/requesttowithdraw/{reference_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """RequestToWithdrawTransactionStatus
     ...
     This operation is used to get the status of a request to withdraw. X-Reference-Id that was passed in
    the post is used as reference to the request.
