...
def _get_kwargs(
    *,
    body: CreateInvoice | Unset = UNSET,
    authorization: str,
...
def sync_detailed(
    *,
    ...
    """CreateInvoice
     ...
     A merchant may use this in order to create an invoice that can be paid by an intended payer via any
