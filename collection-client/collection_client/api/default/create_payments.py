...
from ...models.create_payments import CreatePayments
...
def _get_kwargs(
    *,
    body: CreatePayments | Unset = UNSET,
    authorization: str,
...
def sync_detailed(
    *,
    ...
    """CreatePayments
     ...
     Making it possible to perform payments via the partner gateway. This may be used to pay for external
    bills or to perform air-time top-ups.
