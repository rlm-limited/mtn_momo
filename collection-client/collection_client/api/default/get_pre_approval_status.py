...
from ...models.pre_approval_result import PreApprovalResult
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v2_0/preapproval/{reference_id}".format(
...
) -> ErrorReason | PreApprovalResult | None:
    if response.status_code == 200:
        response_200 = PreApprovalResult.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorReason | PreApprovalResult]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """GetPreApprovalStatus
     ...
     This operation is used to get the status of a pre-approval. X-Reference-Id that was passed in the
